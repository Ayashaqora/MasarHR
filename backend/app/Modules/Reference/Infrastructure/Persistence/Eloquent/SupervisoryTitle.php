...
/** Supervisory title reference values. DEFINED STRUCTURE / VALUES DEFERRED (S05 §5.3). */
#[Fillable(['code', 'name_ar', 'name_en', 'display_order', 'is_active'])]
class SupervisoryTitle extends Model
{
    protected $table = 'ref.supervisory_titles';
