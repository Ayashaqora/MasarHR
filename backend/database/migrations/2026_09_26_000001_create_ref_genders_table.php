...
/**
 * ref.genders — Gender reference values (S05 §5.2/§22).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.genders', function (Blueprint $table): void {
            ...
            $table->unique('code', 'genders_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."genders"
                ADD CONSTRAINT "genders_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.genders');
    }
};
