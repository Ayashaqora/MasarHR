...
/**
 * ref.academic_degrees — Academic degree reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.academic_degrees', function (Blueprint $table): void {
            ...
            $table->unique('code', 'academic_degrees_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."academic_degrees"
                ADD CONSTRAINT "academic_degrees_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.academic_degrees');
    }
};
