...
/**
 * ref.decision_types — Administrative decision type reference values. Structure only for S05 — no rows seeded (§5.2/§22).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.decision_types', function (Blueprint $table): void {
            ...
            $table->unique('code', 'decision_types_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."decision_types"
                ADD CONSTRAINT "decision_types_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.decision_types');
    }
};
