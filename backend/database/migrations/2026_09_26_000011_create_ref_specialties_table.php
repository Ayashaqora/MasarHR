...
/**
 * ref.specialties — Specialty reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.specialties', function (Blueprint $table): void {
            ...
            $table->unique('code', 'specialties_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."specialties"
                ADD CONSTRAINT "specialties_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.specialties');
    }
};
