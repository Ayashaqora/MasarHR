...
/**
 * ref.employment_categories — Employment category reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.employment_categories', function (Blueprint $table): void {
            ...
            $table->unique('code', 'employment_categories_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."employment_categories"
                ADD CONSTRAINT "employment_categories_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.employment_categories');
    }
};
