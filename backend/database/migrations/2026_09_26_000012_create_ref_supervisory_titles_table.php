...
/**
 * ref.supervisory_titles — Supervisory title reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.supervisory_titles', function (Blueprint $table): void {
            ...
            $table->unique('code', 'supervisory_titles_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."supervisory_titles"
                ADD CONSTRAINT "supervisory_titles_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.supervisory_titles');
    }
};
