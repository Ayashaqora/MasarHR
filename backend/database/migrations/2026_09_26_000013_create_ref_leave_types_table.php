...
/**
 * ref.leave_types — Leave type reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.leave_types', function (Blueprint $table): void {
        ...
        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."leave_types"
                ADD CONSTRAINT "leave_types_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.leave_types');
    }
};
