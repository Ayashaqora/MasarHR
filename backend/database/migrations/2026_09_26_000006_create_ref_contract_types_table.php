...
/**
 * ref.contract_types — Contract type reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.contract_types', function (Blueprint $table): void {
            ...
            $table->unique('code', 'contract_types_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."contract_types"
                ADD CONSTRAINT "contract_types_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.contract_types');
    }
};
