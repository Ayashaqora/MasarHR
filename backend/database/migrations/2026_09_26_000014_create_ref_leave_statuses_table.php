...
/**
 * ref.leave_statuses — Leave status reference values. DEFINED STRUCTURE / VALUES DEFERRED (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.leave_statuses', function (Blueprint $table): void {
            ...
            $table->unique('code', 'leave_statuses_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."leave_statuses"
                ADD CONSTRAINT "leave_statuses_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.leave_statuses');
    }
};
