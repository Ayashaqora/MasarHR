...
/**
 * ref.employment_types — Employment type reference values. DEFINED STRUCTURE / VALUES DEFERRED — no authoritative catalog given in S05 (§5.3).
 *
...
return new class extends Migration
{
    ...
    {
        Schema::create('ref.employment_types', function (Blueprint $table): void {
            ...
            $table->unique('code', 'employment_types_code_unique');
        });

        DB::statement(<<<'SQL'
            ALTER TABLE "ref"."employment_types"
                ADD CONSTRAINT "employment_types_version_check"
                CHECK ("version" >= 1)
            SQL);
    }
    ...
    {
        Schema::dropIfExists('ref.employment_types');
    }
};
